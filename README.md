你好，欢迎您可以下载到这些文件，这些文件是我在2020年6-7月的课程中所学到的单片机代码，这些代码是基于Reg51.h的，你可以使用Keil uVision4打开它，然后点击魔法棒图标然后点击 Output  -  Create HEX File HEX Format 一般情况下是HEX-80，如果不是，请更正， 然后在前面点击打钩，从而导出。
